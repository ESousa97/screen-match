...
Instâncias de comportamento abusivo, de assédio ou de outra forma inaceitável podem ser reportadas ao mantenedor do projeto via [Issues do GitHub](https://github.com/ESousa97/screen-match/issues).
